		...
		var iatObj =
		{
         ...
         category2: {
            ...
            title: {
               ...
               css: { color: '#31940F', 'font-size': '2.3em', "font-family": "arial" }, //Style of the category title.
               height: 4 //Used to position the "Or" in the combined block.
            },
            stimulusMedia: [ //Stimuli content as PIP's media objects
               { word: "Rebecca" },
         ...
         attribute2:
         {
			...
			'<span style="font-family:arial">If you make a mistake, a red <font color="#ff0000"><b>X</b></font> will appear. </span>' +
			'<span style="font-family:arial">Press the other key to continue</span>.<p/>',
			...
			instAttributePractice: '<div><p align="center" style="font-size:20px; font-family:arial">' +
				...
				'<span style="font-family:arial">If you make a mistake, a red <font color="#ff0000"><b>X</b></font> will appear. </span>' +
				'<span style="font-family:arial">Press the other key to continue</span>.<br/>' +
				'<u>Go as fast as you can</u> while being accurate.<br/><br/></p>'+
				'<p align="center" style="font-family:arial">Press the <b>space bar</b> when you are ready to start.</font></p></div>',
			...
			fb_strong_Att1WithCatA_Att2WithCatB : 'Your responses suggested a strong automatic association of attribute1 with categoryA and attribute2 with categoryB.',
			fb_moderate_Att1WithCatA_Att2WithCatB : 'Your responses suggested a moderate automatic association of attribute1 with categoryA and attribute2 with categoryB.',
			fb_slight_Att1WithCatA_Att2WithCatB : 'Your responses suggested a slight automatic association of attribute1 with categoryA and attribute2 with categoryB.',
			fb_equal_CatAvsCatB : 'Your responses suggested little to no automatic association between gender and family or career.',
      ...
      API.addSettings('onEnd', window.minnoJS.onEnd);
		...
		API.addSettings('logger', {
			...
			onRow: function (logName, log, settings, ctx) {
				...
				console.log("onrow", log, settings, ctx);
				console.log(document.getElementById("logDump"))
				document.getElementById("logDump").value += convertObjectToCSV(log) + "\n"
				if (!ctx.logs) ctx.logs = ["log_serial;trial_id;name;response_handle;latency;stimuli/0;media/0;data/score;data/parcel;data/corResp;data/condition;data/block"];
				ctx.logs.push(log);	
            },
            // onEnd trigger save (by returning a value)
			onEnd: function (name, settings, ctx) {
				console.log('onend: ' + name);
				console.log("END", ctx.logs);
					return ctx.logs;
            },
            // Transform logs into a string
            // we save as CSV because qualtrics limits to 20K characters and this is more efficient.
			serialize: function (name, logs) {
					console.log("serialize", name, logs);
