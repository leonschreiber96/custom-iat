   define(['pipAPI', 'https://cdn.jsdelivr.net/gh/leonschreiber96/custom-iat@latest/xxx.js'], function (APIConstructor, iatExtension) {
      ...
      return iatExtension({
         ...
         instAttributePractice: '<div><p align="center" style="font-size:20px; font-family:arial">' +
				...
				'<span style="font-family:arial">Ein rotes <font color="#ff0000"><b>X</b></font> erscheint, wenn Sie einen Fehler machen\. </span>' +
				'<span style="font-family:arial">Korrigieren Sie den Fehler, indem Sie die andere Taste drücken.<br/></span>' +
...
instCategoriesPracticeTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px; font-family:arial">',
						'<br/>',
						'Bewegen Sie Ihren Finger über den <b>linken</b> grünen Bereich für Items, die zur Kategorie <font color="#31940F">leftCategory</font> gehören.<br/>',
						'Bewegen Sie Ihren Finger über den <b>rechten</b> grünen Bereich für Items, die zur Kategorie <font color="#31940F">rightCategory</font> gehören.<br/>',
...
instFirstCombined : '<div><p align="center" style="font-size:20px; font-family:arial">' +
				'<font color="#000000"><u>Teil blockNum von nBlocks </u><br/><br/></p>' +
				'<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
				'Benutzen Sie die Taste <b>E</b> für die Kategorie <font color="#31940F">leftCategory</font> und für <font color="#0000ff">leftAttribute</font>.<br/>' +
				'Benutzen Sie die Taste <b>I</b> für die Kategorie <font color="#31940F">rightCategory</font> und für  <font color="#0000ff">rightAttribute</font>.<br/>' +
...
instSwitchCategories : '<div><p align="center" style="font-size:20px; font-family:arial">' +
				...
				'Platzieren Sie Ihren linken Finger auf der Taste <b>E</b> für die Kategorie <font color="#31940F">leftCategory</font>.<br/>' +
				'Platzieren Sie Ihren rechten Finger auf der Taste <b>I</b> für die Kategorie <font color="#31940F">rightCategory</font>.<br/><br/>' +
				'<u>Reagieren Sie so schnell wie möglich</u> und seien Sie dabei präzise.<br/><br/></p>' +
				'<p align="center" style="font-family:arial">Drücken Sie die <b>Leertaste</b>, wenn Sie bereit sind, zu beginnen.</font></p></div>',
instSwitchCategoriesTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						...
						'Berühren Sie den <b>linken</b> grünen Bereich für Items, die zur Kategorie <font color="#31940F">leftCategory</font> gehören.<br/>',
						'Berühren Sie den <b>rechten</b> grünen Bereich für Items, die zur Kategorie <font color="#31940F">rightCategory</font> gehören.<br/>',
						'Items erscheinen nacheinander.<br/>',
						'<br/>',
						'Reagieren Sie so schnell wie möglich und seien Sie dabei präzise.<br/>',
					'</p>',
